...
<?PHP
   ...
   // El fichero introducido supera el límite de tamaño permitido
      else if ($_FILES['imagen']['error'] == UPLOAD_ERR_FORM_SIZE)
      {
         ...
         $errores = $errores . "   <LI>El tamaño del fichero supera el l�mite permitido ($maxsize bytes)\n";
      }
   ...
   // Mostrar errores encontrados
      ...
      // Mostrar datos introducidos
         ...
         print ("<P>[ <A HREF='subirficheros.php'>Insertar otra noticia</A> ]</P>\n");
      }
   }
   else
   {
...
<FORM CLASS="borde" ACTION="subirficheros.php" METHOD="POST" ENCTYPE="multipart/form-data">
